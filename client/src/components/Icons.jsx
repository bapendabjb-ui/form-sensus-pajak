...
export const DAFTAR_IKON_FORMULIR = [
  ...
  { key: "car", label: "Mobil", Ikon: Car },
  { key: "motorbike", label: "Sepeda motor", Ikon: Motorbike },
  { key: "bus", label: "Bus", Ikon: Bus },
  { key: "truck", label: "Truk / angkutan barang", Ikon: Truck },
  { key: "tractor", label: "Alat berat", Ikon: Tractor },
  { key: "ship", label: "Kapal", Ikon: Ship },
  { key: "drama", label: "Hiburan / kesenian", Ikon: Drama },
  { key: "mic-vocal", label: "Karaoke", Ikon: MicVocal },
  { key: "music", label: "Musik", Ikon: Music },
  { key: "clapperboard", label: "Pertunjukan / bioskop", Ikon: Clapperboard },
  { key: "ferris-wheel", label: "Taman rekreasi", Ikon: FerrisWheel },
